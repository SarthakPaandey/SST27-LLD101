...
public final class Order {
    ...
    public List<OrderLine> getLines() { return Collections.unmodifiableList(new ArrayList<>(lines)); }
    ...
    public static class Builder {
        ...
        public Order build() {
            ...
            if (customerEmail == null || !customerEmail.contains("@")) {
                throw new IllegalArgumentException("customerEmail must be a valid email");
            }
